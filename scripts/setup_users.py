...
class UserSetupManager:
    ...
    def create_user(self, username: str, role: str, email: str = "", 
                   full_name: str = "", github_username: str = "") -> bool:
    ...
    def list_users(self, show_deleted: bool = False) -> None:
        ...
        try:
            ...
            print("📋 User List:")
            print("-" * 80)
            print(f"{'Username':<15} {'Role':<12} {'Email':<25} {'Full Name':<20} {'Status':<10}")
            print("-" * 80)
            ...
            for username, details in config.items():
                ...
                print(f"{username:<15} {role:<12} {email:<25} {full_name:<20} {status:<10}")
...
Examples:
  ...
  python setup_users.py report
    ...
    create_parser.add_argument('--role', required=True, choices=['tool_maker', 'agent_smith', 'admin'], help='User role')
    ...
    list_parser.add_argument('--show-deleted', action='store_true', help='Include deleted users')
    ...
    update_parser.add_argument('--role', required=True, choices=['tool_maker', 'agent_smith', 'admin'], help='New role')
