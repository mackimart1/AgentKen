...
class FirebaseAuthIntegration:
    ...
    def _initialize_firebase(self):
        ...
        try:
            if os.path.exists(self.config_file):
                ...
                logger.info("Using default Firebase app (GOOGLE_APPLICATION_CREDENTIALS)")
    ...
    def get_or_create_user(self, firebase_user: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if existing_role:
            ...
            log_audit_event(uid, "user_created", "firebase_auth", {
                "email": email,
    ...
    def update_user_role(self, uid: str, new_role: UserRole, updated_by: str):
        ...
        try:
            ...
            log_audit_event(updated_by, "role_updated", uid, {
    ...
    def delete_user(self, uid: str, deleted_by: str) -> bool:
        ...
        try:
            ...
            log_audit_event(deleted_by, "user_deleted", uid, {
                "deleted_user": uid
            })
...
def create_firebase_auth_blueprint(firebase_auth: FirebaseAuthIntegration):
    ...
    def firebase_login():
        ...
        try:
            ...
            log_audit_event(user_info['user_id'], "login", "firebase_auth", {
                "email": firebase_user.get('email'),
                "provider": "firebase"
            })
    ...
    def firebase_logout():
        ...
        if 'user_id' in session:
            log_audit_event(session['user_id'], "logout", "firebase_auth", {
                "provider": "firebase"
            })
            session.clear()
