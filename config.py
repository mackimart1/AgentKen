...
class ModelConfig:
    ...
    def __init__(self):
        ...
        self.model_name = get_env_var("DEFAULT_MODEL_NAME", "deepseek/deepseek-chat-v3-0324:free")
        self.temperature = float(get_env_var("DEFAULT_MODEL_TEMPERATURE", "0.1"))
        self.api_key = get_env_var("OPENROUTER_API_KEY", "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")
...
class OrchestratorConfig:
    ...
    def __init__(self):
        self.max_concurrent_tasks = int(get_env_var("ORCHESTRATOR_MAX_CONCURRENT_TASKS", "20"))
        self.default_task_priority = get_env_var("ORCHESTRATOR_DEFAULT_PRIORITY", "NORMAL")
        self.enable_optimization = get_env_var("ORCHESTRATOR_ENABLE_OPTIMIZATION", "true").lower() == 'true'
...
class ToolConfig:
    ...
    def __init__(self):
        ...
        self.default_rate_limit = int(get_env_var("TOOL_DEFAULT_RATE_LIMIT", "10")) # per second
...
def initialize_language_model():
    ...
    try:
        ...
        if model_config.api_key and model_config.api_key != "your_openrouter_api_key_here":
            model = ChatOpenAI(
            ...
            logging.warning("OpenRouter API key not found, language model not initialized")
            return None
