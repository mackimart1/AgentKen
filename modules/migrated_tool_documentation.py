"""
Migrated tool module: tool_documentation
...
class MigratedToolDocumentation(ToolModule):
    ...
    def __init__(self, module_id: str, config: Dict[str, Any] = None):
        ...
        self.metadata = ModuleMetadata(
            id="tool_documentation_migrated",
            ...
            tags=["migrated", "tool", "tool_documentation"],
            category="migrated"
        )
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "tool_documentation"}
