"""
Migrated agent module: test_data_processor
...
class MigratedTestDataProcessor(AgentModule):
    ...
    def __init__(self, module_id: str, config: Dict[str, Any] = None):
        ...
        self.metadata = ModuleMetadata(
            id="test_data_processor_migrated",
            ...
            tags=["migrated", "agent", "test_data_processor"],
            category="migrated"
        )
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "test_data_processor"}
