"""
Migrated tool module: delete_file
...
class MigratedDeleteFile(ToolModule):
    ...
    def __init__(self, module_id: str, config: Dict[str, Any] = None):
        ...
        self.metadata = ModuleMetadata(
            ...
            tags=["migrated", "tool", "delete_file"],
            category="migrated"
        )
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "delete_file"}
