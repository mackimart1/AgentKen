"""
Migrated agent module: learning_agent
...
class MigratedLearningAgent(AgentModule):
    ...
    def __init__(self, module_id: str, config: Dict[str, Any] = None):
        ...
        self.metadata = ModuleMetadata(
            ...
            tags=["migrated", "agent", "learning_agent"],
            category="migrated"
        )
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "learning_agent"}
