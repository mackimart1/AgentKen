"""
Migrated tool module: calculator
...
class MigratedCalculator(ToolModule):
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "calculator"}
