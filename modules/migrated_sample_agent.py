"""
Migrated agent module: sample_agent
...
class MigratedSampleAgent(AgentModule):
    ...
    def __init__(self, module_id: str, config: Dict[str, Any] = None):
        ...
        self.metadata = ModuleMetadata(
            ...
            tags=["migrated", "agent", "sample_agent"],
            category="migrated"
        )
    ...
    def _execute_original(self, **kwargs) -> Any:
        ...
        return {"status": "executed", "component": "sample_agent"}
