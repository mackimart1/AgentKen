...
class TestAgentSmith(unittest.TestCase):
    ...
    def test_agent_smith_invocation_structure(self, mock_workflow_manager):
        ...
        success_message = "Successfully created, formatted, linted, and tested agent: 'test_agent'"
        mock_final_state = {
            'messages': [MagicMock(content=success_message)] 
        }
        ...
        with patch('agents.agent_smith.AgentCreationState') as MockState:
            ...
            mock_state_instance.files_written = ['agents/test_agent.py', 'tests/agents/test_test_agent.py']
    ...
    def test_agent_smith_failure_structure(self, mock_workflow_manager):
        ...
        mock_final_state = {
            'messages': [MagicMock(content=failure_message)] 
        }
        mock_workflow.invoke.return_value = mock_final_state
