...
class AIAssistant:
    ...
    def __init__(self):
        ...
        # Debug configuration
        logging.info(f"AI Assistant initialized with model: {self.model_config.model_name}")
...
Respond naturally and helpfully to user queries about the system, its status, capabilities, and how to use it effectively."""
    ...
    def chat(self, message: str, session_id: str = "default", system_state: Optional[Dict[str, Any]] = None) -> str:
        """
    ...
    def _get_conversation_context(self, session_id: str, system_state: Optional[Dict[str, Any]]) -> ConversationContext:
        """Get or create conversation context"""
    ...
    def _generate_response(self, context: ConversationContext) -> str:
        ...
        try:
            ...
            if response.status_code == 401:
                raise Exception(f"API Authentication failed. Please check your OpenRouter API key. Status: {response.status_code}")
    ...
    def _trim_conversation_history(self, context: ConversationContext, max_messages: int = 20):
        """Keep conversation history manageable"""
...
class SmartCommandProcessor:
    ...
    def process_natural_language(self, message: str, system_state: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
