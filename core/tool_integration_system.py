...
class PerformanceMonitor:
    ...
    def _update_metrics(self):
        ...
        durations = [e.end_time - e.start_time for e in self.executions 
...
class BaseTool(ABC):
    ...
    def __init__(self, definition: ToolDefinition):
        ...
        self.rate_limiter = RateLimiter(definition.rate_limit) if definition.rate_limit else None
    ...
    def _retry_execution(self, execution: ToolExecution, error_context: ErrorContext, **kwargs) -> Any:
        ...
        logging.warning(f"Retrying {self.definition.name} (attempt {execution.retry_count})")
    ...
    def _handle_error(self, error_context: ErrorContext):
        ...
        # Log error
        logging.error(f"Tool {self.definition.name} failed: {error_context.error_message}")
...
class ToolRegistry:
    ...
    def execute_tool(self, tool_name: str, **kwargs) -> Any:
        ...
        if tool.status != ToolStatus.AVAILABLE:
            raise ToolError(f"Tool '{tool_name}' is not available", ErrorSeverity.MEDIUM)
...
class DataProcessingTool(BaseTool):
    ...
    def _execute(self, data: Dict[str, Any], operation: str = "analyze") -> Dict[str, Any]:
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                raise ToolError(f"Function {func.__name__} timed out after {timeout_seconds}s")
            finally:
