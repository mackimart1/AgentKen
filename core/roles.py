...
class RolePermissionManager:
    ...
    def _load_role_permissions(self) -> Dict[UserRole, List[Permission]]:
        ...
        default_permissions = {
            UserRole.ADMIN: [
                Permission.CREATE_AGENT, Permission.CREATE_TOOL,
                Permission.MODIFY_AGENT, Permission.MODIFY_TOOL,
                Permission.DELETE_AGENT, Permission.DELETE_TOOL,
                Permission.VIEW_AGENTS, Permission.VIEW_TOOLS,
                Permission.MANAGE_USERS, Permission.VIEW_AUDIT_LOGS
            ],
            UserRole.AGENT_SMITH: [
                Permission.CREATE_AGENT, Permission.MODIFY_AGENT,
                Permission.VIEW_AGENTS, Permission.VIEW_TOOLS
            ],
            UserRole.TOOL_MAKER: [
                Permission.CREATE_TOOL, Permission.MODIFY_TOOL,
                Permission.VIEW_AGENTS, Permission.VIEW_TOOLS
            ],
            UserRole.VIEWER: [
                Permission.VIEW_AGENTS, Permission.VIEW_TOOLS
    ...
    def check_permission(self, user_id: str, permission: Permission) -> bool:
        ...
        logger.debug(f"Permission check: user={user_id}, role={role.value}, "
...
def log_audit_event(user_id: str, action: str, resource: str, details: Dict[str, Any] = None):
    ...
    audit_entry = {
        ...
        'resource': resource,
        'details': details or {},
        'user_role': role_manager.get_user_role(user_id).value if role_manager.get_user_role(user_id) else None
    }
