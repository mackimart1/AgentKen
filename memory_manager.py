...
class MemoryManager:
    ...
    def _get_connection(self):
        ...
        if not hasattr(thread_local, 'connection'):
            thread_local.connection = sqlite3.connect(os.path.join(DB_PATH, "memory.db"))
    ...
    def add_memory(self, key: str, value: str, memory_type: str = None, 
                 agent_name: str = None, task_info: str = None, 
        ...
        try:
            ...
            conn.commit()
            logger.info(f"Added memory with key: {key}, type: {memory_type}, importance: {importance}")
            return True
        except Exception as e:
    ...
    def retrieve_memories(self, memory_type: str = None, agent_name: str = None, 
