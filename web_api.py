...
from core.adaptive_orchestrator import (
    AdvancedOrchestrator, TaskPriority, AgentCapacity, ResourceConstraint
)
  ...
  -d '{"message": "What is the system status?"}'</pre>
    ...
    def run(self, host='localhost', port=5000, debug=False):
        ...
        if not FLASK_AVAILABLE:
            raise Exception("Flask is required to run the web API. Install with: pip install flask flask-cors")
